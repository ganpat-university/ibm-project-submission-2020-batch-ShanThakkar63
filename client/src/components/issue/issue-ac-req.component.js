            ...
            <div className="container">
                <div className="row">
                    <div className="col-lg-8">
                        <h4>
                            <strong><i className="fas fa-file-export fa-fw"></i> Request for Product #{staffReq.item_no} | {item.item_name}</strong>
                        </h4>
                        <hr />
                        <div className="row">
                ...
                <div className="row">
                    <div className="submit-form col-lg-8">
                        {this.state.submitted ? (
                            <div>
                                <h4>Product issued successfully!</h4>
                                ...
                                <div>
                                    <div className="row form-group">
                                        <label htmlFor="remarks" className="col-sm-3 font-weight-bolder">Delivery Date</label>
                                        <div>
                                            <DatePicker
