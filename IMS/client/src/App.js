...
import trackdis from "./components/trackdis";
import UpdateStatus from './components/request/UpdateStatus';
import BillingSystem from './components/BillingSystem';
//import DistributorInventory from './components/item/DistributorInventory';
import DistributorInventory from "./components/item/DistributorInventory";
                                ...
                                >
                                    <div className="container d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 mt-3 border-bottom">
                                        <Switch>
                                            ...
                                            <Route path="/trackdis" component={trackdis} />
                                            
                                            
                                            <Route path="/update-status/:requestId" component={UpdateStatus} />
                                            <Route path="/billing" component={BillingSystem} />
                                            <Route path="/DistributorInventory" component={DistributorInventory} />
